...
@section('content')
    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-100">
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Forum Pengajar</h1>
            <p class="text-gray-600">Berbagi informasi dan diskusi dengan sesama pengajar</p>
        </div>
        ...
        <div id="posts-container">
            ...
            @empty
                <div class="bg-white rounded-lg shadow-sm p-12 text-center">
                    ...
                    <p class="text-gray-500">Mulai berbagi tips dan motivasi untuk alumni!</p>
                </div>
            @endforelse
        </div>
                ...
                <form id="createPostForm" action="{{ route('forum-alumni.store') }}" method="POST"
                    ...
                    <div class="p-4">
                        ...
                        <textarea name="content" id="postContent" rows="6"
                            ...
                            placeholder="Bagikan tips atau motivasi untuk pengajar..." required></textarea>
