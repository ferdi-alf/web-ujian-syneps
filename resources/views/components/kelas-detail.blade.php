...
<section class="min-h-screen bg-white py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-6">
            <a href="{{ route('index') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-teal-300 via-emerald-300 to-emerald-400 text-gray-900 font-semibold shadow hover:shadow-lg transition-all">
        ...
        @if(session('success'))
            <div class="mb-6 bg-emerald-50 border border-emerald-200 text-emerald-800 px-6 py-4 rounded-lg shadow-sm" id="success-alert">
        ...
        @if($errors->any())
            <div class="mb-6 bg-red-50 border border-red-200 text-red-800 px-6 py-4 rounded-lg shadow-sm" id="error-alert">
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white shadow-2xl rounded-2xl overflow-hidden ring-1 ring-gray-100">
                    <!-- Header -->
                    <div class="px-6 py-8 text-center bg-gradient-to-r from-teal-300 via-emerald-300 to-emerald-400">
                        <h1 class="text-3xl font-extrabold text-gray-900">Registrasi Kelas: {{ $kelasDetail->nama }}</h1>
                        <p class="text-gray-800/80 mt-2">Lengkapi data Anda dengan mengikuti langkah-langkah berikut</p>
                    </div>
                    ...
                    <div class="bg-white px-6 py-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center flex-1">
                                <div id="step-1-circle" class="w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-white font-semibold transition-all duration-300">1</div>
                                <div class="ml-3"><p id="step-1-title" class="text-sm font-medium text-emerald-600">Data Pribadi</p></div>
                            </div>
                            <!-- Connector 1 -->
                            <div id="connector-1" class="flex-1 h-0.5 bg-gray-300 mx-4 transition-all duration-300"></div>
                            <!-- Step 2 -->
                            <div class="flex items-center flex-1">
                                <div id="step-2-circle" class="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center text-gray-500 font-semibold transition-all duration-300">2</div>
                                <div class="ml-3"><p id="step-2-title" class="text-sm font-medium text-gray-500">Kontak & Alamat</p></div>
                            </div>
                            <!-- Connector 2 -->
                            <div id="connector-2" class="flex-1 h-0.5 bg-gray-300 mx-4 transition-all duration-300"></div>
                            <!-- Step 3 -->
                            <div class="flex items-center flex-1">
                                <div id="step-3-circle" class="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center text-gray-500 font-semibold transition-all duration-300">3</div>
                                <div class="ml-3"><p id="step-3-title" class="text-sm font-medium text-gray-500">Pembayaran</p></div>
                            </div>
                        </div>
                    </div>

                    <!-- Form Container -->
                    <form method="POST" action="{{ route('daftar.store') }}" enctype="multipart/form-data" class="px-6 pb-8" id="form-daftar" data-dp-persen="{{ (int)($kelasDetail->dp_persen ?? 0) }}">
                        @csrf
                        ...
                        <div id="step-1" class="transition duration-500 transform step-content animate__animated">
                            <div class="space-y-6">
                                <h2 class="text-2xl font-semibold text-gray-800 border-b border-gray-200 pb-3">Data Pribadi</h2>
                                <div>
                                    ...
                                    <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200" placeholder="Masukkan nama lengkap Anda" required>
                                ...
                                <div>
                                    ...
                                    <div class="flex space-x-6">
                                        <label class="flex items-center cursor-pointer"><input type="radio" name="jenis_kelamin" value="Laki-laki" {{ old('jenis_kelamin') == 'Laki-laki' ? 'checked' : '' }} class="w-4 h-4 text-emerald-600 border-gray-300 focus:ring-emerald-500"><span class="ml-2 text-gray-700">Laki-laki</span></label>
                                        <label class="flex items-center cursor-pointer"><input type="radio" name="jenis_kelamin" value="Perempuan" {{ old('jenis_kelamin') == 'Perempuan' ? 'checked' : '' }} class="w-4 h-4 text-emerald-600 border-gray-300 focus:ring-emerald-500"><span class="ml-2 text-gray-700">Perempuan</span></label>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <select id="pendidikan_terakhir" name="pendidikan_terakhir" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200">
                        ...
                        <div id="step-2" class="transition duration-500 transform step-content hidden animate__animated">
                            <div class="space-y-6">
                                <h2 class="text-2xl font-semibold text-gray-800 border-b border-gray-200 pb-3">Kontak & Alamat</h2>
                                <div>
                                    <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email <span class="text-red-500">*</span></label>
                                    <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200" placeholder="contoh@email.com" required>
                                    @error('email')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label for="no_hp" class="block text-sm font-medium text-gray-700 mb-2">No. HP <span class="text-red-500">*</span></label>
                                    <input type="tel" id="no_hp" name="no_hp" value="{{ old('no_hp') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200" placeholder="08xx xxxx xxxx" required>
                                ...
                                <div>
                                    ...
                                    <textarea id="alamat" name="alamat" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200 resize-none" placeholder="Masukkan alamat lengkap Anda" required>{{ old('alamat') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <select id="mengetahui_program_dari" name="mengetahui_program_dari" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200" required>
                                    ...
                                    @error('mengetahui_program_dari')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="step-3" class="transition duration-500 transform step-content hidden animate__animated">
                            <div class="space-y-6">
                                <h2 class="text-2xl font-semibold text-gray-800 border-b border-gray-200 pb-3">Pembayaran</h2>

                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Total Tagihan <span class="text-red-500">*</span></label>
                                        <input type="number" name="total_tagihan" id="total_tagihan" value="{{ old('total_tagihan', $kelasDetail->harga) }}" step="1" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200" required>
                                        @error('total_tagihan')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Jumlah Cicilan <span class="text-red-500">*</span></label>
                                        <select name="jumlah_cicilan" id="jumlah_cicilan" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200" required>
                                            @for($i=1;$i<=12;$i++)
                                                <option value="{{ $i }}" {{ (int)old('jumlah_cicilan', 1) === $i ? 'selected' : '' }}>{{ $i }}x</option>
                                            @endfor
                                        </select>
                                        @error('jumlah_cicilan')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                                    </div>
                                    <div class="md:col-span-2 grid md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" name="tagihan_per_bulan" id="tagihan_per_bulan" value="{{ old('tagihan_per_bulan') }}" step="1" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200" readonly>
                                            @error('tagihan_per_bulan')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div id="drop-area" class="w-full h-48 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center text-gray-500 cursor-pointer hover:border-emerald-500 transition-colors duration-200">
                                        <div class="text-center">
                                            <p>Seret dan lepas gambar di sini atau klik untuk memilih</p>
                                            <p class="text-sm text-gray-400">Hanya file JPG, PNG (maks. 2MB)</p>
                                        </div>
                                    </div>
                                    ...
                                    <div id="image-preview" class="mt-4 hidden">
                                        ...
                                        <button type="button" id="remove-image" class="mt-2 text-red-500 text-sm hover:text-red-700">Hapus Gambar</button>
                                    </div>
                                    @error('bukti_pembayaran_dp')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                        ...
                        <div class="flex justify-between mt-8 pt-6 border-t border-gray-200">
                            <button type="button" id="prevBtn" class="hidden px-6 py-3 rounded-xl bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-4 focus:ring-gray-200 transition-all font-medium">
                            ...
                            <button type="button" id="nextBtn" class="ml-auto px-6 py-3 rounded-xl bg-gradient-to-r from-teal-300 via-emerald-300 to-emerald-400 text-gray-900 hover:shadow-lg focus:ring-4 focus:ring-emerald-200 transition-all font-semibold">
                                Selanjutnya
                            ...
                            <button type="submit" id="submitBtn" class="hidden ml-auto px-8 py-3 rounded-xl bg-gradient-to-r from-teal-300 via-emerald-300 to-emerald-400 text-gray-900 hover:shadow-lg focus:ring-4 focus:ring-emerald-200 transition-all font-semibold">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:sticky lg:top-24">
                    ...
                    <div class="mt-6 grid sm:grid-cols-2 gap-4">
                        <div class="p-4 rounded-xl bg-gradient-to-r from-gray-50 to-emerald-50 border border-emerald-100">
                            ...
                            <div class="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Rp {{ number_format($kelasDetail->harga, 0, ',', '.') }}</div>
                        </div>
                        <div class="p-4 rounded-xl bg-gradient-to-r from-gray-50 to-emerald-50 border border-emerald-100">
                            <div class="text-sm text-gray-500">DP</div>
                            <div class="text-xl font-bold text-gray-900">{{ (int) ($kelasDetail->dp_persen ?? 0) }}% <span class="text-sm font-semibold text-gray-600">(Rp {{ number_format(($kelasDetail->harga * ($kelasDetail->dp_persen ?? 0)) / 100, 0, ',', '.') }})</span></div>
                        </div>
                    </div>

                    <div class="mt-8">
                        <h3 class="text-lg font-semibold text-gray-900 mb-3">Apa yang kamu dapat</h3>
                        ...
                        <div class="mt-8 p-4 rounded-xl bg-emerald-50 border border-emerald-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-emerald-700 text-sm">{{ $activeBatch->nama ?? 'Batch Terbuka' }}</div>
                                </div>
                            </div>
                        </div>
                    @endif
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateStepperUI(step) {
            for (let i = 1; i <= totalSteps; i++) {
                ...
                if (i < step) {
                    setCircle(circle, 'w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-white font-semibold transition-all duration-300', '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>');
                    title.className = 'text-sm font-medium text-emerald-600';
                    if (connector) connector.className = 'flex-1 h-0.5 bg-emerald-500 mx-4 transition-all duration-300';
                } else if (i === step) {
                    setCircle(circle, 'w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-white font-semibold transition-all duration-300 ring-4 ring-emerald-200', String(i));
                    title.className = 'text-sm font-medium text-emerald-600';
                    if (connector) connector.className = 'flex-1 h-0.5 bg-gray-300 mx-4 transition-all duration-300';
                } else {
                    setCircle(circle, 'w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center text-gray-500 font-semibold transition-all duration-300', String(i));
            ...
            if (currentStep === 1) {
                ...
                if (!isGenderSelected) {
                    ...
                    if (genderContainer && !genderContainer.querySelector('.gender-error')) {
                        const errorMsg = document.createElement('p');
                        errorMsg.className = 'text-red-500 text-sm mt-1 gender-error';
